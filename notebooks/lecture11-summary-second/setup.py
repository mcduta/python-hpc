...
# usage:   python setup.py config_fc --f90flags="-O3 -mavx -fopenmp" install --prefix=$PWD
#          python setup.py config_fc --fcompiler=intelem --f90flags="-O3 -mavx -fopenmp" install --prefix=$PWD
